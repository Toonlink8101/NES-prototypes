...
irq_routines_table:
        ...
        .word irq_routine_two_step
            .byte DMCFREQ_IRQ_RATE72, DMCFREQ_IRQ_RATE54
...
irq_routines_table_align_0:
        ...
        .word irq_routine_two_step_align
            .byte DMCFREQ_IRQ_RATE84, DMCFREQ_IRQ_RATE54, <irq_routines_table_align_3
        ; cpu cycles = 29782    offset = -1.5

irq_routines_table_align_1:
        .word irq_routine_one_step
            .byte DMCFREQ_IRQ_RATE160
        .word irq_routine_one_step
            .byte DMCFREQ_IRQ_RATE72
        .word irq_routine_two_step_align
            .byte DMCFREQ_IRQ_RATE226, DMCFREQ_IRQ_RATE54, <irq_routines_table_align_0
...
irq_routines_table_align_2:
        ...
        .word irq_routine_one_step
            .byte DMCFREQ_IRQ_RATE72
        .word irq_routine_two_step_align
            .byte DMCFREQ_IRQ_RATE226, DMCFREQ_IRQ_RATE54, <irq_routines_table_align_1
        ; cpu cycles = 29780    offset = 0.5
...
irq_routines_table_align_3:
        ...
        .word irq_routine_one_step
            .byte DMCFREQ_IRQ_RATE72
        .word irq_routine_two_step_align
            .byte DMCFREQ_IRQ_RATE226, DMCFREQ_IRQ_RATE54, <irq_routines_table_align_2
        ; cpu cycles = 29780    offset = 0.5